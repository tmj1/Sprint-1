...
const inputRepeatPassword = inputs[1].parentElement.parentElement.querySelector(`.${inputValidateConfig.inputHelperTextSelector}`);
...
function disabledBtn() {
    if (document.forms[0].checkValidity()) {
        if (inputs[0].value === inputs[1].value) submitBtn.classList.remove(inputValidateConfig.isDisableBtnSubmitSelector);
        else submitBtn.classList.add(inputValidateConfig.isDisableBtnSubmitSelector);
    }
}
isMatchedPassword();

//# sourceMappingURL=register.06c1cd32.js.map
